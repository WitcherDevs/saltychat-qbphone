...
$(document).on('click', '.twitter-header-tab', function (e) {
    ...
    if (PressedTwitterTab !== CurrentTwitterTab) {
        ...
        if (PressedTwitterTab === "twitter-mentions") {
            $.post('http://qb-phone_deluxe/ClearMentions');
        }
        ...
        if (PressedTwitterTab == "twitter-self") {
            $.post('http://qb-phone_deluxe/GetSelfTweets', JSON.stringify({}), function (selfdata) {
...
$(document).on('click', '.tweet-delete', function (e) {
    ...
    $.post('http://qb-phone_deluxe/GetSelfTweets', JSON.stringify({}), function (tweets) {
...
$(document).on('click', '#send-tweet', function (e) {
    ...
    if (TweetMessage != "" || TweetUrl != "") {
        ...
        $.post('http://qb-phone_deluxe/PostNewTweet', JSON.stringify({
...
$(document).on('click', '#send-photo', function (e) {
    ...
    $.post('http://qb-phone_deluxe/PostNewImage', JSON.stringify({}),
        function (url) {
...
$(document).on('click', '.hashtag-tag-text', function (e) {
    ...
    if (!HashtagOpen) {
        ...
        $.post('http://qb-phone_deluxe/GetHashtagMessages', JSON.stringify({
            hashtag: Hashtag
