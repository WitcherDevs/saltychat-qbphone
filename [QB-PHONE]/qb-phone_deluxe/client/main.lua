...
CancelCall = function()
    ...
    TriggerServerEvent('hinehmfix:CancelCall', GetPlayerServerId(PlayerId()), PhoneData.CallData)
...
function AnswerCall()
    if (PhoneData.CallData.CallType == "incoming" or PhoneData.CallData.CallType == "outgoing") and PhoneData.CallData.InCall and not PhoneData.CallData.AnsweredCall then
        ...
        TriggerServerEvent('hinehmfix:AnswerCall', GetPlayerServerId(PlayerId()), PhoneData.CallData)
if Config.Tokovoip then
