...
RegisterServerEvent('hinehmfix:AnswerCall')
AddEventHandler('hinehmfix:AnswerCall', function(Ply, tply)
    local TPlayer = GetPlayerFromPhone(tply.TargetData.number)
	print(ply)
	print(GetPlayerFromPhone(tply.TargetData.number))
...
RegisterServerEvent('hinehmfix:CancelCall')
AddEventHandler('hinehmfix:CancelCall', function(Ply, tply)
    local TPlayer = GetPlayerFromPhone(tply.TargetData.number)
	print(ply)
	print(GetPlayerFromPhone(tply.TargetData.number))
